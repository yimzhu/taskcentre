 ...
 */
@Slf4j
public class ReviewTaskStateMachine extends AbstractStateMachine<ReviewTaskStateMachine, ReviewState, ReviewEvent, ReviewTask> {

    private ApplicationContext applicationContext;

    public ReviewTaskStateMachine(ApplicationContext applicationContext) {
