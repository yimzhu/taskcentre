...
@Component
@Slf4j
public class DelegateTransitionCondition extends AnonymousCondition<DelegateTask> {

    private final DelegateTaskServiceImpl delegateTaskService;

    public DelegateTransitionCondition(DelegateTaskServiceImpl delegateTaskService) {
    ...
    public boolean isSatisfied(DelegateTask context) {
        ...
        return delegateTaskService.count(queryWrapper)==0?true:false;
    }
}
